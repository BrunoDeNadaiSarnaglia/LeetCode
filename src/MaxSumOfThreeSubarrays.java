public class MaxSumOfThreeSubarrays {
  public int[] maxSumOfThreeSubarrays(int[] nums, int k) {
    ...
    for (int i = 3 * k + 1; i <= nums.length; i++) {
      dp3[i] = acc[dp3[i - 1]] - acc[dp3[i - 1] - k] + acc[dp2[i - k - 1]] - acc[dp2[i - k - 1] - k] + acc[dp1[i - 2*k - 1]] - acc[dp1[i - 2*k - 1] - k] < acc[i] - acc[i - k] + acc[dp2[i - k]] - acc[dp2[i - k] - k] + acc[dp1[i - 2*k]] - acc[dp1[i - 2*k] - k] ? i : dp3[i - 1];
    }
